   ...
   <img src="./ColorVocabProject/goal.png" alt="Color Vocabulary" width="500" height="300"> <br />
    ...
    <p><b>In this project we covered </b>
        <ul>
            ...
            <li>How to use flexibox float left and float right properties</li>
            <li>How to change the position of an element using sticky positioning</li>
            <li>How to use media quire for responsiveness</li>
            <li>How to change the position of an element  and create a responsive screen</li>
        </ul>
    </p>
    <li><a href="./FlexboxPricingTableProject/">PRISCING TABLE </a></li>
    <br />
